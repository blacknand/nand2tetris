...
class VMWriter {
    ...
    public:
        ...
        void writePush(const std::string &segment, const int &index, index, std::string comment = "");
        ...
        void writeCall(const std::string &name, const int &nArgs, std::string comment = "");
        void writeFunction(const std::string &name, const int &nVars, std::string comment = "");
        void writeReturn();
        void close();
};
